...
* Understand different batch correction methods using one sample sequenced in two different runs.
...
```{r GSM3872442_readIn, cache=FALSE, eval=FALSE}
...
<!-- this is a lot of duplication, do I really need it? -->
